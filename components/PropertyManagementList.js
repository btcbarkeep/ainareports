  ...
  const renderRow = (pm, index) => {
    ...
    return (
      ...
      >
        ...
        <div className="w-2/5 min-w-0 pr-4 relative flex-shrink-0 overflow-hidden">
          {isPaid && (
        ...
        <div className="w-1/3 min-w-0 pl-4 pr-4 overflow-hidden flex items-center gap-1.5 flex-shrink-0">
        ...
        {propertyManagers.some(pm => pm.unit_count !== undefined) && (
          <div className="flex-1 min-w-0 pl-4 overflow-hidden flex items-center justify-center flex-shrink-0">
    ...
    <>
      <div className="border rounded-md divide-y text-sm overflow-hidden">
        <div className="flex px-3 py-2 font-semibold text-gray-700">
          <div className="w-2/5 min-w-0 flex-shrink-0">Name</div>
          <div className="w-1/3 min-w-0 pl-4 pr-4 overflow-hidden flex items-center flex-shrink-0">
            <span className="ml-5">License</span>
          </div>
          {propertyManagers.some(pm => pm.unit_count !== undefined) && (
            <div className="flex-1 min-w-0 pl-4 overflow-hidden text-center flex-shrink-0">Units</div>
          )}
        </div>
