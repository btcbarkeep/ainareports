              ...
              <>
                ...
                <div className="border rounded-md divide-y text-sm">
                  <div className="flex px-3 py-2 font-semibold text-gray-700">
                    ...
                    <div className="w-1/5 min-w-0">Severity</div>
                    <div className="w-1/5 min-w-0">Created By</div>
                    <div className="w-1/5 text-right min-w-0">Date</div>
                  </div>
                  ...
                  {events.length === 0 ? (
                    ...
                    events.map((e) => (
                      <div key={e.id} className="flex px-3 py-2">
                        ...
                        <div className="w-1/5 min-w-0 pr-2 overflow-hidden">
                        ...
                        <div className="w-1/5 text-right min-w-0 overflow-hidden">
